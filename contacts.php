...
<section class="b-pageHeader">
		...
		<div class="b-breadCumbs s-shadow wow zoomInUp" data-wow-delay="0.5s">
			<div class="container">
				<a href="index.php" class="b-breadCumbs__page">Home</a><span class="fa fa-angle-right"></span><a href="contacts.php" class="b-breadCumbs__page m-active">Contact Us</a>
			</div>
		</div><!--b-breadCumbs-->
				...
				<div class="row">
					<div class="col-xs-6">
						<div class="b-contacts__form">
							...
							<div id="success"></div>
							<form id="contactForm" action="#" method="post" class="s-form wow zoomInUp" data-wow-delay="0.5s">								
								<input type="text" placeholder="YOUR NAME" name="user_name" required pattern="[A-Za-z\s]*" title="Alphabets only" />
								<input type="email" placeholder="EMAIL ADDRESS" name="user_email" required />
								<input type="text" placeholder="PHONE NO." name="user_phone" maxlength="10" pattern=".{10,10}" title="Enter 10 digit number" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" required />
								<textarea name="user_message" placeholder="COMMENT/SUGGESTIONS/FEEDBACK" required></textarea>
								<input type="hidden" value="yes" name="contact" />
								<button type="submit" id="subclicked" class="btn m-btn">SUBMIT NOW<span class="fa fa-angle-right"></span></button>
							</form>
						</div>
					</div>
					<div class="col-xs-6">
							...
							<div class="b-contacts__address-info">
								...
								<address class="b-contacts__address-info-main wow zoomInUp" data-wow-delay="0.5s">
									<div class="b-contacts__address-info-main-item">
										...
										ADDRESS
										<p>JP Nagar 5th phase, Bangalore</p>
									</div>
									<div class="b-contacts__address-info-main-item">
										<div class="row">
...
<!--bxSlider-->
		...
		<script src="assets/js/customfunc_contact.js"></script>
