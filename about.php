<html>
<head>
    <title>About Us | Easy Cars</title>
					...
					<div class="col-sm-6 col-xs-12">
						<div class="b-best__info">
							<header class="s-lineDownLeft b-best__info-head">
								<h2 class="wow zoomInUp" data-wow-delay="0.5s"></h2>
							</header>
							<h6 class="wow zoomInUp" data-wow-delay="0.5s">  </h6>
							<p class="wow zoomInUp" data-wow-delay="0.5s">  </p>							
						</div>
					</div>
					<div class="col-sm-6 col-xs-12">
						<img class="img-responsive center-block wow zoomInUp" data-wow-delay="0.5s" alt="best" src="" />
					</div>
				</div>
			</div>
		</section><!--b-best-->
