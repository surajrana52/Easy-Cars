...
<nav class="b-nav">
    <div class="container">
			...
			<div id="carousel" class="slide carousel carousel-fade">
				<div class="carousel-inner">
					<div class="item active">
						<img src="assets/images/index-img/mercedes-slider.jpg" alt="sliderImg" />
						<div class="container">
							<div class="carousel-caption b-slider__info">
								<h3>Choose your dream car</h3>
								<h2>MERCEDES AMG</h2>
								<p>Model 2016 <span><i class="fa fa-inr"></i> 85,00,000</span></p>
								<a class="btn m-btn" href="detail.html">see details<span class="fa fa-angle-right"></span></a>
							</div>
						</div>
					</div>
					<div class="item">
						<img src="assets/images/index-img/bmw-main-slider.jpg" alt="sliderImg" />
						<div class="container">
							<div class="carousel-caption b-slider__info">
								<h3>Choose your dream car</h3>
								<h2>BMW M6</h2>
								<p>Model 2016 <span><i class="fa fa-inr"></i> 1,00,00,000</span></p>
								<a class="btn m-btn" href="detail.html">see details<span class="fa fa-angle-right"></span></a>
							</div>
						</div>
					</div>
					<div class="item">
						<img src="assets/images/index-img/skoda-slider.jpg" alt="sliderImg" />
						<div class="container">
							<div class="carousel-caption b-slider__info">
								<h3>Choose your dream car</h3>
								<h2>Skoda Octavia RS</h2>
								<p>Model 2016 <span><i class="fa fa-inr"></i> 50,00,000</span></p>
								<a class="btn m-btn" href="detail.html">see details<span class="fa fa-angle-right"></span></a>
							</div>
						</div>
					</div>
		...
		<section class="b-search">
			<div class="container">
				<form action="searchresult.php" method="POST" class="b-search__main">
					...
					<div class="b-search__main-type wow zoomInUp" data-wow-delay="0.3s">
						...
						<div class="col-xs-12 col-md-10">
							<div class="row">
								<div class="col-xs-2">
									<input id="type6" type="radio" name="cartype" value="hatchback" required/>
								...
								<div class="col-xs-2">
									<input id="type5" type="radio" name="cartype" value="sedan" />
								...
								<div class="col-xs-2">
									<input id="type3" type="radio" name="cartype" value="coupe" />
								...
								<div class="col-xs-2">
									<input id="type4" type="radio" name="cartype" value="convertable" />
								...
								<div class="col-xs-2">
									<input id="type2" type="radio" name="cartype" value="suv" />
						...
						<div class="row">
							...
							<div class="col-md-4 col-xs-12 text-left s-noPadding">
								<div class="b-search__main-form-range">
									...
									<input type="hidden" name="budget" class="j-min" value="200000"/>									
								</div>
								<div class="b-search__main-form-submit">									
									<button type="submit" name="findmycar" value="findclicked" onclick="cartypevald();" class="btn m-btn">Find my Car <span class="fa fa-angle-right"></span></button>
								</div>
							</div>
						</div>
					</div>
				...
				<div id="carousel-small" class="owl-carousel enable-owl-carousel" data-items="4" data-navigation="true" data-auto-play="true" data-stop-on-hover="true" data-items-desktop="4" data-items-desktop-small="4" data-items-tablet="3" data-items-tablet-small="2">
					<div>
						<div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
							<a href="detail.html">
								<img src="assets/images/featured-img/suzuki-swift.jpg" alt="mers" />							
							</a>
							<div class="b-featured__item-price">
								<i class="fa fa-rupee"> 4.65 - 7.64 Lakh</i>
							</div>
							<div class="clearfix"></div>
							<h5><a href="detail.html">Maruti Suzuki Swift</a></h5>
							<div class="b-featured__item-count"><span class="fa fa-tachometer"></span>20.4 - 25.2 KMPL</div>
							<div class="b-featured__item-links">								
								<a href="#">2016</a>
								<a href="#">Manual</a>
								<a href="#">White</a>
								<a href="#">Petrol/Diesel</a>
							</div>
						</div>
					</div>
					<div>
						<div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
							<a href="detail.html">
								<img src="assets/images/featured-img/hyundai_i20.jpg" alt="audi" />
								<span class="m-leasing">Best Selling</span>
							</a>
							<div class="b-featured__item-price">
								<i class="fa fa-rupee"> 5.66 - 8.98 Lakh</i>
							</div>
							<div class="clearfix"></div>
							<h5><a href="detail.html">Hyundai Elite i20</a></h5>
							<div class="b-featured__item-count"><span class="fa fa-tachometer"></span>18.15 - 22.54 KMPL</div>
							<div class="b-featured__item-links">								
								<a href="#">2016</a>
								<a href="#">Manual</a>
								<a href="#">Red</a>
					...
					<div>
						<div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
							<a href="detail.html">
								<img src="assets/images/featured-img/marutisuzuki_baleno.jpg" alt="aston" />								
							</a>
							<div class="b-featured__item-price">
								<i class="fa fa-rupee"> 5.44 - 8.60 Lakh</i>
							</div>
							<div class="clearfix"></div>
							<h5><a href="detail.html">Maruti Suzuki Baleno</a></h5>
							<div class="b-featured__item-count"><span class="fa fa-tachometer"></span>21.04 - 27.39 KMPL</div>
							<div class="b-featured__item-links">								
								<a href="#">2016</a>
								<a href="#">Manual</a>
								<a href="#">Blue</a>
					...
					<div>
						<div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
							<a href="detail.html">
								<img src="assets/images/featured-img/renault_kwid.jpg" alt="jaguar" />
								<span class="m-premium">New Luanch</span>
							</a>
							<div class="b-featured__item-price">
								<i class="fa fa-rupee"> 2.79 - 3.84 Lakh*</i>
							</div>
							<div class="clearfix"></div>
							<h5><a href="detail.html">Renault Kwid</a></h5>
							<div class="b-featured__item-count"><span class="fa fa-tachometer"></span>25.17 kmpl</div>
							<div class="b-featured__item-links">								
								<a href="#">2016</a>
								<a href="#">Manual</a>
								<a href="#">Lime Green</a>
					...
					<div>
						<div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
							<a href="detail.html">
								<img src="assets/images/featured-img/maruti_suzuki_wagon.jpg" alt="mers" />								
							</a>
							<div class="b-featured__item-price">
								<i class="fa fa-rupee"> 4.25 - 5.32 Lakh*</i>
							</div>
							<div class="clearfix"></div>
							<h5><a href="detail.html">Maruti Suzuki Wagon R</a></h5>
							<div class="b-featured__item-count"><span class="fa fa-tachometer"></span>20.51 - 26.6 kmpl</div>
							<div class="b-featured__item-links">																
								<a href="#">Manual</a>
								<a href="#">Blue</a>
								<a href="#">Petrol/CNG + Diesel</a>
							</div>
						</div>
					</div>													
				</div>
				...
				<div class="row">
					<div class="col-md-5 col-md-offset-2 col-sm-6 col-xs-12">
						<div class="b-welcome__text wow fadeInLeft" data-wow-delay="0.3s" data-wow-offset="100">
							<h2>Finding your Dream Car made easy</h2>
							<h3>WELCOME TO EasyCars</h3>
							<p>At EasyCars, We simply don't want you to waste your time and energy at local car dealers researching to find the best car. Our rich catalogue of new and upcoming cars gives you immense options to choose from as per your need, along with technical specification and price list that you can rely on.</p>
							<p>All data used on this site is DUMMY DATA and might not represent actual cars specification as we have developed this project for a competition. </p>
							<ul>
								<li><span class="fa fa-check"></span>EMI Calculator</li>
								<li><span class="fa fa-check"></span>Map based car availability with dealer.</li>
								<li><span class="fa fa-check"></span>Accurate car specifications.</li>
								<li><span class="fa fa-check"></span>Live chat with experts.</li>
							</ul>
						</div>
					</div>
		...
		<section class="b-world">
			<div class="container">
				...
				<h2 class="s-title wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">Upcoming Cars 2016/2017</h2>
				<div class="row">					
					<div class="col-sm-4 col-xs-12">
						<div class="b-world__item wow zoomInUp" data-wow-delay="0.3s" data-wow-offset="100">
							<img class="img-responsive"  src="assets/images/upcoming-img/volkswagen-passat.png" alt="mazda" />
							<div class="b-world__item-val">
								<span class="b-world__item-val-title">Expected Launch Date</span>								
								<span class="b-world__item-num">APR 2016 - SEP 2016</span>
							</div>
							<h2>Volkswagen Passat</h2>
							<p>The Volkswagen Passat has always been the most impressive vehicle in its segment and pretty popular in other markets but has been overshadowed by its rivals here in India..</p>
					...
					<div class="col-sm-4 col-xs-12">
						<div class="b-world__item wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
							<img class="img-responsive" src="assets/images/upcoming-img/chevrolet-beat-activ.png" alt="wolks" />
							<div class="b-world__item-val">
								<span class="b-world__item-val-title">Expected Launch Date</span>								
								<span class="b-world__item-num">APR 2016 - SEP 2016</span>
							</div>							
							<h2>Chevrolet Beat Activ</h2>
							<p>Chevrolet Beat Activ interiors are likely 
							to be painted in dual tone colours with touch of matching exterior colours that will surely give it a trendier look.</p>
					...
					<div class="col-sm-4 col-xs-12">
						<div class="b-world__item j-item wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">
							<img class="img-responsive"  src="assets/images/upcoming-img/jaguar-f-pace.png" alt="chevrolet" />
							<div class="b-world__item-val">
								<span class="b-world__item-val-title">Expected Launch Date</span>								
								<span class="b-world__item-num">APR 2016 - SEP 2016</span>
							</div>
							<h2>Jaguar F Pace</h2>
							<p>Christened as the ‘Ultimate practical sports car’ by Jaguar , F-Pace is the first ever 
							crossover being produced by Jag something that is usually done by Land Rover</p>
							<a href="article.html" class="btn m-btn">READ MORE<span class="fa fa-angle-right"></span></a>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-10 col-sm-offset-1 col-xs-12 col-md-offset-0">
						<div class="b-asks__first m-second wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">
							...
							<div class="b-asks__first-info">
								<h2>Need any Help?</h2>
								<p>Use contact us page to get in touch with us. Our support team will help you choose your dream car</p>
							</div>							
						</div>
					</div>
					<div class="col-xs-12">
						<p class="b-asks__call wow zoomInUp" data-wow-delay="0.3s" data-wow-offset="100">QUESTIONS? CALL US  : <span>1800-111-000</span></p>
					</div>
				</div>
			</div>
		</section><!--b-asks-->
		...
		<section class="b-auto">
			<div class="container">
				...
				<h2 class="s-title wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">GANESH CHATURTHI OFFERS 2016</h2>
				<div class="row">
					<div class="col-xs-5 col-sm-4 col-md-3">
						<aside class="b-auto__main-nav wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
							<ul class="list-brands">
								<li class="active" data-to='#id1' onclick="divshow('id1')"><a href="javascript:void(0)">Current Offers</a><span class="fa fa-angle-right"></span></li>								
							</ul>							
						</aside>
					</div>
					<div class="b-auto__main">							
							...
							<!--Start all MANUFACTURER section -->
							<div class="row m-margin" id="id1">
								<div class="col-md-4 col-sm-6 col-xs-12">
									<div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
										<img class="img-responsive"  src="assets/images/offers/Datsun-redi-GO1.jpg" alt="mazda" />
										<div class="b-world__item-val">
											<span class="b-world__item-val-title"></span>
										</div>										
										<h2><a href="detail.html">Datsun Redi GO</a></h2>
										<div class="b-auto__main-item-info">
											<span class="m-price">
												<i class="fa fa-rupee"><del> 4.80 L</del></i> / 											
												&nbsp;<i class="fa fa-rupee"> 4.20 L</i>
											</span>
										</div>
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									<div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
										<img class="img-responsive"  src="assets/images/offers/volkswagen-ameo.jpg" alt="mazda" />
										<div class="b-world__item-val">
											<span class="b-world__item-val-title"></span>
										</div>										
										<h2><a href="detail.html">Volkswagen Ameo</a></h2>
										<div class="b-auto__main-item-info">
											<span class="m-price">
												<i class="fa fa-rupee"><del> 7.13 L</del></i> / 											
												&nbsp;<i class="fa fa-rupee"> 6.90 L</i>
											</span>
										</div>
										<div class="b-featured__item-links m-auto">										
											<a href="#">2016</a>
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									<div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
										<img class="img-responsive"  src="assets/images/offers/honda-brv.jpg" alt="mazda" />
										<div class="b-world__item-val">
											<span class="b-world__item-val-title"></span>
										</div>										
										<h2><a href="detail.html">Honda BRV</a></h2>
										<div class="b-auto__main-item-info">
											<span class="m-price">
												<i class="fa fa-rupee"><del> 13.76 L</del></i> / 											
												&nbsp;<i class="fa fa-rupee"> 13.52 L</i>
											</span>
										</div>
										<div class="b-featured__item-links m-auto">										
											<a href="#">2016</a>
				...
				<div class="row wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
					...
					<div class="col-xs-8">
						<div class="b-contact__form">
							...
							<form id="form1-subsc" action="#" method="POST">
								<div><span class="fa fa-user"></span><input type="text" name="name" placeholder="Your Name" required/></div>
								<div><span class="fa fa-envelope"></span><input type="email" name="email" placeholder="Your Email" required /></div>
								<input type="hidden" value="yes" name="subsc" />
								<button type="submit" id="subscribe"><span class="fa fa-angle-right"></span></button>
							</form>
						</div>
					</div>
				</div>
...
<!--Owl Carousel-->
		...
		<script src="assets/js/customfunc_index.js"></script>
